...
export CLASSPATH=${WORKSPACE}/Brain/target/Brain-1.5.2-SNAPSHOT.jar:${WORKSPACE}/owltools/OWLTools-Runner/target/OWLTools-Runner-0.3.0-SNAPSHOT.jar:${WORKSPACE}/owlapi/owlapi-distribution-3.5.1.jar
