...
ENV RUN_make_named_edges=false
...
ENV KBSERVER=http://kb.p2.virtualflybrain.org

ENV PDBSERVER=http://pdb.p2.virtualflybrain.org

ENV OWLSERVER=http://owl.p2.virtualflybrain.org
